...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (productRepo.count() == 0) {
            ...
            Review r5 = new Review("Marcus Brody", "Autofocus is unreal! Perfect hybrid camera for both photos and 4K video.", 5, p4);
            Review r6 = new Review("Elena Rostova", "The OLED screen is jaw-dropping. Best tablet for digital artists.", 5, p5);
